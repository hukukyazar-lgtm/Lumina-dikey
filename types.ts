...
// FIX: Added missing types for Design Studio, themes, and game progression.
// Types for Design Studio & Customization
export type ThemePalette = Record<string, string | undefined>;

export type GameBackgrounds = {
    easy: string | null;
    medium: string | null;
    hard: string | null;
};
